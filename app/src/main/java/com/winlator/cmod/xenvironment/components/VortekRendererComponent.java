...
public class VortekRendererComponent extends EnvironmentComponent implements ConnectionHandler, RequestHandler {
    ...
    // Mi Pad 4 / Adreno 512 system driver reports Vulkan 1.1.128. Do not over-advertise 1.3.
    // VK_MAKE_API_VERSION(0, 1, 1, 128)
    public static final int VK_MAX_VERSION = (1 << 22) | (1 << 12) | 128;
